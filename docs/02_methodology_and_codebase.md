...
Initially set to `512` (and with patching generation calls separately hardcoded to `150` — see [doc 05 §8](05_experiment_evolution_history.md)), the context window constraint induced truncation *during* the generation of the computation stage for complex MATH problems. 
